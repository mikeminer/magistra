...
import type { ExternalObject, RefCell, NapiTurboEngineOptions, NapiSourceDiagnostic, NapiProjectOptions, NapiPartialProjectOptions, NapiCodeFrameOptions, NapiCodeFrameLocation, TraceServerHandle, TraceQueryOptions, TraceQueryResult } from './generated-native';
...
export interface Binding {
    ...
    turbo: {
        ...
        startTurbopackTraceServerHandle(traceFilePath: string, port: number | undefined): TraceServerHandle;
        queryTraceSpans(handle: TraceServerHandle, options: TraceQueryOptions): TraceQueryResult;
