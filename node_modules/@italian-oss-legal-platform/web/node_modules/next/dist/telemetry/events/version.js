...
function eventCliSession(nextConfig, event) {
    ...
    if (typeof "16.3.0-canary.6" !== 'string') {
        return [];
    }
    ...
    const payload = {
        ...
        useTurbopackWorkerAssetPrefix: (nextConfig == null ? void 0 : (_nextConfig_experimental = nextConfig.experimental) == null ? void 0 : _nextConfig_experimental.turbopackWorkerAssetPrefix) !== undefined,
        ...
        adapterPath: !!(nextConfig == null ? void 0 : nextConfig.adapterPath)
    };
    return [
        {
