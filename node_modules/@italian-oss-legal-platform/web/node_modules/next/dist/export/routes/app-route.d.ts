...
}, htmlFilepath: string, fileWriter: MultiFileWriter, cacheComponents: boolean, staticPageGenerationTimeout: number, experimental: Required<Pick<ExperimentalConfig, 'authInterrupts' | 'useCacheTimeout'>>, buildId: string): Promise<ExportRouteResult>;
