...
export declare function renderToWebFizzStream(element: React.ReactElement, streamOptions: any): Promise<FizzStreamResult>;
export declare function renderToNodeFizzStream(_element: React.ReactElement, _streamOptions: any): Promise<FizzStreamResult>;
