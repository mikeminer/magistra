...
export declare function renderToNodeFlightStream(ComponentMod: FlightComponentMod, payload: any, clientModules: any, opts: any): AnyStream;
export { renderToWebFizzStream } from './stream-ops.web';
export declare function renderToNodeFizzStream(element: React.ReactElement, streamOptions: any): Promise<FizzStreamResult>;
