...
export interface ExperimentalConfig {
     ...
     */
    turbopackPluginRuntimeStrategy?: 'workerThreads' | 'childProcesses' | 'forceWorkerThreads';
    /**
...
export interface NextConfigRuntime {
    ...
    experimental: Pick<NextConfigComplete['experimental'], 'ppr' | 'taint' | 'serverActions' | 'staleTimes' | 'dynamicOnHover' | 'useOffline' | 'optimisticRouting' | 'inlineCss' | 'prefetchInlining' | 'authInterrupts' | 'useCacheTimeout' | 'clientTraceMetadata' | 'clientParamParsingOrigins' | 'allowedRevalidateHeaderKeys' | 'fetchCacheKeyPrefix' | 'isrFlushToDisk' | 'optimizeCss' | 'nextScriptWorkers' | 'disableOptimizedLoading' | 'largePageDataBytes' | 'serverComponentsHmrCache' | 'caseSensitiveRoutes' | 'validateRSCRequestHeaders' | 'sri' | 'useSkewCookie' | 'preloadEntriesOnStart' | 'hideLogsAfterAbort' | 'removeUncaughtErrorAndRejectionListeners' | 'imgOptConcurrency' | 'imgOptMaxInputPixels' | 'imgOptSequentialRead' | 'imgOptSkipMetadata' | 'imgOptTimeoutInSeconds' | 'proxyClientMaxBodySize' | 'proxyTimeout' | 'testProxy' | 'runtimeServerDeploymentId' | 'maxPostponedStateSize' | 'cachedNavigations' | 'partialFallbacks' | 'exposeTestingApiInProductionBuild' | 'supportsImmutableAssets' | 'useNodeStreams'> & {};
}
