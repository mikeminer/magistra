...
function getDocumentFiles(buildManifest, pathname) {
    ...
    const pageFiles = getPageFiles(buildManifest, pathname);
    return {
        sharedFiles,
        pageFiles,
        allFiles: [
...
function getScripts(context, props, files) {
    ...
    return [
        ...
        const query = file.startsWith('static/immutable/chunks') ? assetQueryString : mutableAssetQueryString;
        return /*#__PURE__*/ _jsx("script", {
        ...
        cssFiles.forEach((file)=>{
            ...
            if (!optimizeCss) {
                cssLinkElements.push(/*#__PURE__*/ _jsx("link", {
                    ...
                    rel: "preload",
                    href: `${assetPrefix}/_next/${encodeURIPath(file)}${cssAssetQueryString}`,
                    as: "style",
...
export function Html(props) {
    const { docComponentsRendered, locale, scriptLoader, deploymentId, __NEXT_DATA__ } = useHtmlContext();
