...
import { parseUrl, parseUrl as parseUrlUtil } from '../shared/lib/router/utils/parse-url';
import { getNextPathnameInfo } from '../shared/lib/router/utils/get-next-pathname-info';
import { RSC_HEADER, NEXT_RSC_UNION_QUERY, NEXT_ROUTER_PREFETCH_HEADER, NEXT_ROUTER_SEGMENT_PREFETCH_HEADER, NEXT_URL, NEXT_ROUTER_STATE_TREE_HEADER, NEXT_INSTANT_TEST_COOKIE } from '../client/components/app-router-headers';
...
import { getMaxPostponedStateSize, getPostponedStateExceededErrorMessage, readBodyWithSizeLimit } from './lib/postponed-request-body';
...
export default class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        ;
        globalThis.NEXT_CLIENT_ASSET_SUFFIX = this.nextConfig.experimental.supportsImmutableAssets || !this.deploymentId ? '' : `?dpl=${this.deploymentId}`;
        ...
        this.renderOpts = {
            ...
            experimental: {
                ...
                optimisticRouting: this.nextConfig.experimental.optimisticRouting ?? false,
                inlineCss: this.nextConfig.experimental.inlineCss ?? false,
                prefetchInlining: this.nextConfig.experimental.prefetchInlining ?? false,
                authInterrupts: !!this.nextConfig.experimental.authInterrupts,
                useCacheTimeout: this.nextConfig.experimental.useCacheTimeout,
                cachedNavigations: this.nextConfig.experimental.cachedNavigations ?? false,
            ...
            logServerFunctions: typeof this.nextConfig.logging === 'object' && Boolean(this.nextConfig.logging.serverFunctions)
        };
            ...
            if (useMatchedPathHeader) {
                try {
                    ...
                    if (this.isAppPPREnabled && this.minimalMode && req.headers[NEXT_RESUME_HEADER] === '1' && req.method === 'POST') {
                        const { maxPostponedStateSize, maxPostponedStateSizeBytes } = getMaxPostponedStateSize(this.nextConfig.experimental.maxPostponedStateSize);
                        ...
                        if (body === null) {
                            res.statusCode = 413;
                            res.body(getPostponedStateExceededErrorMessage(maxPostponedStateSize)).send();
                            return;
                        }
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req, res, pathname, renderOpts: opts }, { components, query }) {
        ...
        !is404Page) {
            ...
            const expectedHash = await computeCacheBustingSearchParam(routerPrefetch, segmentPrefetchRSCRequest, headers[NEXT_ROUTER_STATE_TREE_HEADER], headers[NEXT_URL]);
            ...
            if (!matchesHash && actualHash !== null) {
                ...
                matchesHash = computeLegacyCacheBustingSearchParam(routerPrefetch, segmentPrefetchRSCRequest, headers[NEXT_ROUTER_STATE_TREE_HEADER], headers[NEXT_URL]) === actualHash;
            }
            if (!matchesHash) {
        ...
        let resolvedUrlPathname = getRequestMeta(req, 'rewrittenPathname') || urlPathname;
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && isAppPageRouteModule(routeModule);
        ...
        const exposeTestingApi = this.dev === true || this.nextConfig.experimental.exposeTestingApiInProductionBuild === true;
        ...
        const hasInstantTestCookie = exposeTestingApi && req.headers[RSC_HEADER] === undefined && typeof req.headers.cookie === 'string' && req.headers.cookie.includes(NEXT_INSTANT_TEST_COOKIE + '=') && couldSupportPPR;
        ...
        (hasDebugStaticShellQuery || hasInstantTestCookie) && (exposeTestingApi || this.experimentalTestProxy === true));
        ...
        if ((routeModule == null ? void 0 : routeModule.isDev) && isDynamicRoute(pathname) && (components.getStaticPaths || isAppPath)) {
            ...
            if (this.dev && getStaticPathsStart && ((_pathsResults_staticPaths = pathsResults.staticPaths) == null ? void 0 : _pathsResults_staticPaths.length)) {
            ...
            if (isAppPath && this.nextConfig.cacheComponents) {
                ...
                if ((_pathsResults_prerenderedRoutes = pathsResults.prerenderedRoutes) == null ? void 0 : _pathsResults_prerenderedRoutes.length) {
                    ...
                    if (smallestFallbackRouteParams) {
                        addRequestMeta(req, 'fallbackParams', createOpaqueFallbackRouteParams(smallestFallbackRouteParams));
                    }
                }
            }
        }
