...
import { LIGHTNINGCSS_FEATURE_NAMES } from './config-shared';
...
const zTurbopackLoaderItem = z.union([
    z.string(),
    z.strictObject({
        loader: z.string(),
...
const zTurbopackLoaderBuiltinCondition = z.union([
    z.literal('browser'),
    z.literal('foreign'),
...
const zTurbopackCondition = z.union([
    z.strictObject({
        all: z.lazy(()=>z.array(zTurbopackCondition))
    }),
    z.strictObject({
        any: z.lazy(()=>z.array(zTurbopackCondition))
    }),
    z.strictObject({
        not: z.lazy(()=>zTurbopackCondition)
    }),
...
const zTurbopackRuleConfigItem = z.strictObject({
...
const zTurbopackRuleConfigCollection = z.union([
...
export const experimentalSchema = {
    ...
    turbopackPluginRuntimeStrategy: z.enum([
        'workerThreads',
        'childProcesses',
        'forceWorkerThreads'
    ]).optional(),
    ...
    reportSystemEnvInlining: z.enum([
        'warn',
        'error'
    ]).optional()
};
export const configSchema = z.lazy(()=>z.strictObject({
        ...
        compiler: z.strictObject({
            ...
            define: z.record(z.string(), z.union([
                z.string(),
                z.number(),
                z.boolean()
            ])).optional(),
            defineServer: z.record(z.string(), z.union([
                z.string(),
                z.number(),
                z.boolean()
            ])).optional(),
