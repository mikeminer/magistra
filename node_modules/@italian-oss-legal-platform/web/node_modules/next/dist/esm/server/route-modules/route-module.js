...
import { BUILD_ID_FILE, BUILD_MANIFEST, CLIENT_REFERENCE_MANIFEST, DYNAMIC_CSS_MANIFEST, NEXT_FONT_MANIFEST, PREFETCH_HINTS, PRERENDER_MANIFEST, REACT_LOADABLE_MANIFEST, ROUTES_MANIFEST, SERVER_FILES_MANIFEST, SERVER_REFERENCE_MANIFEST, SUBRESOURCE_INTEGRITY_MANIFEST } from '../../shared/lib/constants';
 ...
 */ export class RouteModule {
    ...
    async prepare(req, res, { srcPage, multiZoneDraftMode }) {
        ...
        const defaultLocale = getRequestMeta(req, 'defaultLocale') || (domainLocale == null ? void 0 : domainLocale.defaultLocale) || (i18n == null ? void 0 : i18n.defaultLocale);
        ...
        if (res && Boolean(req.headers['x-nextjs-data']) && (!res.statusCode || res.statusCode === 200)) {
            res.setHeader('x-nextjs-matched-path', removeTrailingSlash(`${locale ? `/${locale}` : ''}${normalizedSrcPage}`));
        }
        ...
        return {
            ...
            routerServerContext,
            deploymentId,
            clientAssetToken: nextConfig.experimental.supportsImmutableAssets ? '' : deploymentId
        };
    }
