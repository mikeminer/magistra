 ...
 *   as interceptable.
 */ import { EntryStatus, writeRouteIntoCache, fulfillRouteCacheEntry, getCurrentRouteCacheVersion, createMetadataRouteTree } from './cache';
 ...
 */ export function matchKnownRoute(now, pathname, search) {
    const pathnameParts = pathname.split('/').filter((p)=>p !== '');
