...
async function fetchPkgInfo(pkg) {
    ...
    const versionData = data.versions["16.3.0-canary.6"];
    return {
        os: versionData.os,
        cpu: versionData.cpu,
...
async function patchIncorrectLockfile(dir) {
    ...
    const content = (0, _fs.readFileSync)(lockfilePath, 'utf8');
    ...
    try {
        ...
        (0, _fs.writeFileSync)(lockfilePath, JSON.stringify(lockfileParsed, null, 2) + endingNewline);
