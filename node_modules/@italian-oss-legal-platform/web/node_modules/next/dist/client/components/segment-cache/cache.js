...
async function fetchSegmentsOnCacheMiss(route, routeKey, tree, segments, segmentCount) {
    ...
    try {
        ...
        while(node !== null && dataIndex < serverDataArray.length){
            ...
            const canonicalVaryPath = process.env.__NEXT_VARY_PARAMS && data.varyParams !== null ? (0, _varypath.getFulfilledSegmentVaryPath)(node.tree.varyPath, data.varyParams) : (0, _varypath.getSegmentVaryPathForRequest)(_types.FetchStrategy.PPR, node.tree);
            let fulfilled = null;
