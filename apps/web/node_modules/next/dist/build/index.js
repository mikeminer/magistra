...
async function build(dir, experimentalAnalyze = false, reactProductionProfiling = false, debugOutput = false, debugPrerender = false, noMangling = false, appDirOnly = false, bundler = _bundler.Bundler.Turbopack, experimentalBuildMode, traceUploadUrl, debugBuildPaths, enabledFeatures = {}) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const envInfo = (0, _appinfolog.getEnvInfo)(dir);
            ...
            await nextBuildSpan.traceChild('generate-route-types').traceAsyncFn(async ()=>{
                ...
                await (0, _rootparamstypeutils.writeRootParamsTypes)(routeTypesManifest, _path.default.join(distDir, 'types', 'root-params.d.ts'), config);
            });
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("16.3.0-canary.6");
