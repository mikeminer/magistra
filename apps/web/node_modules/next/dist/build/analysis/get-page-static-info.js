...
const _warnaboutedgeruntime = require("../warn-about-edge-runtime");
...
async function getAppPageStaticInfo({ pageFilePath, nextConfig, isDev, page }) {
    ...
    if ((directives == null ? void 0 : directives.has('client')) && 'unstable_instant' in config) {
        throw Object.defineProperty(new Error(`"unstable_instant" is a route segment config and can only be used when the segment is a Server Component module. Remove the "use client" directive from "${pageFilePath}" to use this API.`), "__NEXT_ERROR_CODE", {
            value: "E1159",
            enumerable: false,
            configurable: true
        });
    ...
    if ('unstable_instant' in config && !nextConfig.cacheComponents) {
        throw Object.defineProperty(new Error(`Route "${page}" cannot use \`export const unstable_instant = ...\` without enabling \`cacheComponents\`.`), "__NEXT_ERROR_CODE", {
            value: "E1162",
            enumerable: false,
            configurable: true
        });
    ...
    if ((directives == null ? void 0 : directives.has('client')) && 'unstable_prefetch' in config) {
        throw Object.defineProperty(new Error(`"unstable_prefetch" is a route segment config and can only be used when the segment is a Server Component module. Remove the "use client" directive from "${pageFilePath}" to use this API.`), "__NEXT_ERROR_CODE", {
            value: "E1161",
            enumerable: false,
            configurable: true
        });
    ...
    if ('unstable_prefetch' in config && !nextConfig.cacheComponents) {
        throw Object.defineProperty(new Error(`Route "${page}" cannot use \`export const unstable_prefetch = ...\` without enabling \`cacheComponents\`.`), "__NEXT_ERROR_CODE", {
            value: "E1160",
            enumerable: false,
            configurable: true
        });
    ...
    if ((0, _isedgeruntime.isEdgeRuntime)(config.runtime)) {
        (0, _warnaboutedgeruntime.warnAboutEdgeRuntime)();
    }
    if (config.preferredRegion !== undefined) {
        (0, _warnaboutedgeruntime.warnAboutPreferredRegion)();
    }
    return {
        type: _pagetypes.PAGE_TYPES.APP,
        rsc,
...
async function getPagesPageStaticInfo({ pageFilePath, nextConfig, isDev, page }) {
    ...
    if ((0, _isedgeruntime.isEdgeRuntime)(resolvedRuntime)) {
        (0, _warnaboutedgeruntime.warnAboutEdgeRuntime)();
    }
    if (((_config_config1 = config.config) == null ? void 0 : _config_config1.regions) !== undefined) {
        (0, _warnaboutedgeruntime.warnAboutPreferredRegion)();
    }
    return {
        type: _pagetypes.PAGE_TYPES.PAGES,
