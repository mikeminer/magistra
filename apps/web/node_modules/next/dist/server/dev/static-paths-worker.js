...
async function loadStaticPaths({ dir, distDir, pathname, config, httpAgentOptions, locales, defaultLocale, isAppPath, page, isrFlushToDisk, fetchCacheKeyPrefix, cacheMaxMemorySize, requestHeaders, cacheHandler, cacheHandlers, cacheLifeProfiles, nextConfigOutput, buildId, authInterrupts, useCacheTimeout, staticPageGenerationTimeout, sriEnabled }) {
    ...
    if (isAppPath) {
        ...
        routeModule);
        const route = (0, _app1.parseNormalizedAppRoute)(pathname);
