...
const experimentalSchema = {
    outputHashSalt: _zod.z.string().optional(),
    ...
    swcEnvOptions: _zod.z.object({
        mode: _zod.z.enum([
            'usage',
            'entry'
        ]).optional(),
        coreJs: _zod.z.string().optional(),
        skip: _zod.z.array(_zod.z.string()).optional(),
        include: _zod.z.array(_zod.z.string()).optional(),
        exclude: _zod.z.array(_zod.z.string()).optional(),
        shippedProposals: _zod.z.boolean().optional(),
        forceAllTransforms: _zod.z.boolean().optional(),
        debug: _zod.z.boolean().optional(),
        loose: _zod.z.boolean().optional()
    }).optional(),
    ...
    useCacheTimeout: _zod.z.number().positive().optional(),
    useNodeStreams: _zod.z.boolean().optional(),
    ...
    supportsImmutableAssets: _zod.z.boolean().optional(),
...
const configSchema = _zod.z.lazy(()=>_zod.z.strictObject({
        ...
        agentRules: _zod.z.boolean().optional(),
