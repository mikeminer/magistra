...
const _detectagent = require("../../telemetry/detect-agent");
...
function logStartInfo({ networkUrl, appUrl, envInfo, logBundler }) {
    ...
    _log.bootstrap(`${(0, _picocolors.bold)((0, _picocolors.purple)(`${_log.prefixes.ready} Next.js ${"16.3.0-canary.6"}`))}${versionSuffix}`);
    if (appUrl) {
...
function ensureAgentRulesForDev(dir) {
    if ((0, _detectagent.detectAgent)() === null) return null;
    if ((0, _generateagentfiles.hasAgentRulesInstalled)(dir)) return null;
