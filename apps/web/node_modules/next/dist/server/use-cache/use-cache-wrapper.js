    ...
    switch(outerWorkUnitStore.type){
        ...
        case 'request':
            ...
            if (process.env.__NEXT_DEV_SERVER && outerWorkUnitStore.cacheSignal) {
                ...
                if ((stagedRendering == null ? void 0 : stagedRendering.currentStage) !== _stagedrendering.RenderStage.Dynamic) {
...
async function cache(kind, id, boundArgsLength, originalFn, args) {
    ...
    if (renderResumeDataCache) {
        ...
        if (rdcEntry !== undefined) {
            ...
            if (rdcResult !== undefined) {
                if (rdcResult.entry.revalidate === 0 || rdcResult.entry.expire < _constants.DYNAMIC_EXPIRE) {
                    switch(workUnitStore.type){
                        case 'prerender':
                        ...
                        case 'request':
                            {
                                if (process.env.NODE_ENV === 'development') {
                                    ...
                                    if (rdcResult.entry.expire < _constants.DYNAMIC_EXPIRE && rdcResult.hasExplicitExpire === false) {
                                        throw wrapAsInvalidDynamicUsageError(Object.defineProperty(new Error(nestedCacheShortExpireErrorMessage), "__NEXT_ERROR_CODE", {
                                            value: "E1009",
                                            enumerable: false,
                                            configurable: true
                ...
                if (rdcResult.entry.stale < _constants.RUNTIME_PREFETCH_DYNAMIC_STALE) {
                    switch(workUnitStore.type){
                        case 'prerender-runtime':
                ...
                if (entry !== undefined && (entry.revalidate === 0 || entry.expire < _constants.DYNAMIC_EXPIRE)) {
                    switch(workUnitStore.type){
                        case 'prerender':
                            ...
                            const hangingPromise = (0, _dynamicrenderingutils.makeHangingPromise)(workUnitStore.renderSignal, workStore.route, 'dynamic "use cache"');
