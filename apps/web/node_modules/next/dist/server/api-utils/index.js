...
function checkIsOnDemandRevalidate(req, previewProps) {
    ...
    const previewModeId = headers[_constants.PRERENDER_REVALIDATE_HEADER];
    const isOnDemandRevalidate = previewModeId === previewProps.previewModeId;
    const revalidateOnlyGenerated = headers.hasOwnProperty(_constants.PRERENDER_REVALIDATE_ONLY_GENERATED_HEADER);
    return {
        isOnDemandRevalidate,
        revalidateOnlyGenerated
    };
