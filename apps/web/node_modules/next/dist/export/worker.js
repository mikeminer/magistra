...
async function exportPageImpl(input, fileWriter) {
    var _req_url;
    const { exportPath, distDir, pagesDataDir, buildExport = false, subFolders = false, optimizeCss, disableOptimizedLoading, debugOutput = false, enableExperimentalReact, enableNodeStreams, trailingSlash, sriEnabled, renderOpts: commonRenderOpts, outDir: commonOutDir, buildId, deploymentId, clientAssetToken, renderResumeDataCache } = input;
    ...
    (0, _requestmeta.addRequestMeta)(req, 'resolvedPathname', (0, _removetrailingslash.removeTrailingSlash)(updatedPath));
    ...
    if (isAppDir && (0, _isapprouteroute.isAppRouteRoute)(page)) {
        return (0, _approute.exportAppRoute)(req, res, params, page, components.routeModule, commonRenderOpts.incrementalCache, commonRenderOpts.cacheLifeProfiles, htmlFilepath, fileWriter, commonRenderOpts.cacheComponents, commonRenderOpts.staticPageGenerationTimeout, commonRenderOpts.experimental, buildId);
    }
    const renderOpts = {
        ...components,
        ...commonRenderOpts,
...
async function exportPages(input) {
    ...
    const exportPageWithRetry = async (exportPath, maxAttempts)=>{
        ...
        const renderResumeDataCache = renderResumeDataCachesByPage[pageKey] ? (0, _resumedatacache.createRenderResumeDataCache)(renderResumeDataCachesByPage[pageKey], renderOpts.experimental.maxPostponedStateSizeBytes) : undefined;
