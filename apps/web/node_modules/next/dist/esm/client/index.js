...
export const version = "16.3.0-canary.6";
export let router;
...
function renderError(renderErrorProps) {
    ...
    return pageLoader.loadPage('/_error').then(({ page: ErrorComponent, styleSheets })=>{
        return lastAppProps?.Component === ErrorComponent ? import('../pages/_error').then((errorModule)=>{
        ...
        return Promise.resolve(renderErrorProps.props?.err ? renderErrorProps.props : loadGetInitialProps(App, appCtx)).then((initProps)=>doRender({
                ...renderErrorProps,
                err,
                Component: ErrorComponent,
                styleSheets,
