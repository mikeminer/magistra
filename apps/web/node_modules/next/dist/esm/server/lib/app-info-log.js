...
import { hasAgentRulesInstalled, writeAgentFiles } from './generate-agent-files';
/**
 ...
 */ export function logStartInfo({ networkUrl, appUrl, envInfo, logBundler }) {
    ...
    Log.bootstrap(`${bold(purple(`${Log.prefixes.ready} Next.js ${"16.3.0-canary.6"}`))}${versionSuffix}`);
    if (appUrl) {
 ...
 */ export function ensureAgentRulesForDev(dir) {
