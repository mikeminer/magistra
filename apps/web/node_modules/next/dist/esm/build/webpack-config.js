...
import { CLIENT_STATIC_FILES_RUNTIME_MAIN, CLIENT_STATIC_FILES_RUNTIME_MAIN_APP, CLIENT_STATIC_FILES_RUNTIME_POLYFILLS_SYMBOL, CLIENT_STATIC_FILES_RUNTIME_REACT_REFRESH, CLIENT_STATIC_FILES_RUNTIME_WEBPACK, MIDDLEWARE_REACT_LOADABLE_MANIFEST, REACT_LOADABLE_MANIFEST, SERVER_DIRECTORY, COMPILER_NAMES } from '../shared/lib/constants';
...
export default async function getBaseWebpackConfig(dir, { buildId, encryptionKey, config, compilerType, dev = false, entrypoints, deferredEntrypoints, isDevFallback = false, pagesDir, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling, jsConfig, jsConfigPath, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, fetchCacheKeyPrefix, isCompileMode, previewProps }) {
    ...
    function exclude(excludePath) {
        ...
        const shouldExclude = excludePath.includes('node_modules') && !babelIncludeRegexes.some((r)=>r.test(excludePath)) && !isResourceInPackages(excludePath, finalTranspilePackages);
    ...
    const babelLoader = getBabelLoader(useSWCLoader, babelConfigFile, isNodeOrEdgeCompilation, distDir, pagesDir, dir, appDir || pagesDir, dev, isClient, config.reactCompiler, codeCondition.exclude);
    const reactCompilerLoader = babelLoader ? undefined : getReactCompilerLoader(config.reactCompiler, dir, isNodeOrEdgeCompilation, codeCondition.exclude, dev);
    ...
    let webpackConfig = {
        ...
        output: {
            ...
            ...((_config_experimental1 = config.experimental) == null ? void 0 : _config_experimental1.outputHashSalt) ? {
                ...
                ...!config.images.disableStaticImages ? [
                    {
                        ...
                        options: {
                            ...
                            outputHashSalt: (_config_experimental2 = config.experimental) == null ? void 0 : _config_experimental2.outputHashSalt
                        }
                    }
                ] : [],
                ...isEdgeServer ? [
        ...
        plugins: [
            ...
            !isRspack && ((_config_experimental_deferredEntries = config.experimental.deferredEntries) == null ? void 0 : _config_experimental_deferredEntries.length) && deferredEntrypoints && new DeferredEntriesPlugin({
                dev,
                config,
                deferredEntrypoints
            }),
            ...
            dev && isClient && (isRspack ? new (require('next/dist/compiled/@next/react-refresh-utils/dist/ReactRefreshRspackPlugin')).default() : new ReactRefreshWebpackPlugin(webpack)),
            ...
            isRspack && new (getRspackCore()).NextExternalsPlugin({
                compilerType,
                config,
                optOutBundlingPackageRegex,
    ...
    const cache = {
        ...
        version: `${__dirname}|${"16.3.0-canary.6"}|${configVars}`,
