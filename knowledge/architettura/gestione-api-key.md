...
description: Configurazione e conservazione cifrata delle chiavi dei provider LLM dell'istanza, senza lock-in.
...
Permette di configurare le chiavi dell'istanza per i [provider LLM](/architettura/provider-llm.md): nessun abbonamento e nessun lock-in, l'utente porta la propria chiave.
