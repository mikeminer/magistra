...
- [Backend / API](./backend-api.md): TypeScript / Node.
- [Worker di ingest](./worker-ingest.md): TypeScript / Node, processo separato dall'API.
- [Database applicativo](./database-applicativo.md) e [indice normativo](./indice-normativo.md): PGlite embedded (Postgres in WASM con `pgvector`) come source of truth.
