...
Variante del [RAG](./rag.md) in cui l'LLM agisce come **agente** del recupero: prima di cercare, **ragiona** sulla richiesta e produce una o più query mirate (vedi [pianificazione delle query](../architettura/pianificazione-query.md)), e può **iterare** il retrieval se il contesto raccolto è insufficiente.
