...
Fase di **riordino** dei risultati di una ricerca: dopo aver recuperato un primo insieme di [chunk](../modello-dati/chunk.md) candidati (per [ricerca semantica](./ricerca-semantica.md) o per parola chiave), un secondo modello li riordina per rilevanza rispetto alla domanda.
