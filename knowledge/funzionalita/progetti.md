...
Un **progetto** è uno spazio di lavoro che raggruppa [documenti](../modello-dati/documento.md), [conversazioni](../modello-dati/conversazione.md) e [workflow](./workflow.md) attorno a una pratica o a un cliente, usato da una sola persona.

## Cosa offre

- **Organizzazione**: i documenti caricati vivono dentro un progetto.
- **Contesto per l'assistente**: l'[assistente legale](./assistente-legale.md) può usare i documenti del progetto, oltre al corpus normativo, come base delle risposte.
