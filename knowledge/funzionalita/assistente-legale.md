...
- Può operare **dentro un [progetto](./progetti.md)**, usando come contesto i documenti caricati dall'utente oltre al corpus normativo.
- Può eseguire azioni sui documenti: [analizzarli](./analisi-documenti.md), [redigerli](./redazione-documenti.md) o [revisionarli](./revisione-tracciata.md).
- Oltre a trovare la norma, può supportare il **[ragionamento strategico](./ragionamento-strategico.md)**: incrociare norme, [orientamenti di legittimità](../glossario/orientamento-giurisprudenziale.md) e [calcolo di pene e termini](./calcolo-pena-termini.md) per presentare opzioni e conseguenze sul singolo caso.
