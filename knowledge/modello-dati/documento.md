...
Un file **dell'utente** (contratto, atto, parere) caricato o generato dentro un [Progetto](./progetto.md). Da non confondere con la [Norma](./norma.md), che appartiene al corpus pubblico.
