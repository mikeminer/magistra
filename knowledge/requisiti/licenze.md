...
- **Giurisprudenza**: in questa fase si integra la [Corte Costituzionale](/fonti/giurisprudenza.md) (apertamente licenziata); per la **Cassazione**, l'MVP parte dalle fonti **aperte** (giustizia.it/SentenzeWeb) e l'eventuale integrazione dei servizi commerciali (CED/DeJure) è rimandata al **post-MVP**. Il nodo delle licenze commerciali **non blocca l'MVP**. Mappatura puntuale: [#24](https://github.com/Italian-Builders-Org/magistra/issues/24).
